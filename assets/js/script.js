...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Wajahat Ali Basharat Portfolio";
...
var typed = new Typed(".typing-text", {
    strings: ["Data Science", "Machine Learning Engineer", "Deep Learning Enthusiast", "Computer Vision Enthusiast", "Natural Language Processing Enthusiast"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
